...
{
    int i;
    LRUCache *cache = malloc(2 * sizeof(int) + sizeof(struct list_head) + capacity * sizeof(struct list_head));
...
int main(int argc, char **argv)
{
    ...
    printf("cache.put(1, 1);\n");
    lRUCachePut(obj, 1, 1);
    printf("cache.put(2, 2);\n");
    lRUCachePut(obj, 2, 2);
    printf("cache.get(1);     // returns %d\n", lRUCacheGet(obj, 1));
    printf("cache.put(3, 3);  // evicts key 2\n");
    lRUCachePut(obj, 3, 3);
    printf("cache.get(2);     // returns %d\n", lRUCacheGet(obj, 2));
    printf("cache.put(4, 4);  // evicts key 1\n");
    lRUCachePut(obj, 4, 4);
    printf("cache.get(1);     // returns %d\n", lRUCacheGet(obj, 1));
    printf("cache.get(3);     // returns %d\n", lRUCacheGet(obj, 3));
    printf("cache.get(4);     // returns %d\n", lRUCacheGet(obj, 4));
